## Este projeto foi feito em Next e Typescript
Tem como objetivo mostrar as inscrições de usuarios em um curso e te dá também a opção de criar um usuário, foi utilizado o Mirage como fake Api e ChakraUI como estilização.
